...
class MultiTaskLoss(nn.Module):
    ...
    def __init__(self, seg_type: Literal['bce_with_logits','dice']='bce_with_logits', cls_type: Literal['bce_with_logits']='bce_with_logits',
                 seg_weight: float=1.0, cls_weight: float=1.0):
        super().__init__()
        if seg_type == 'dice':
    ...
    def forward(self, seg_logits, seg_targets, cls_logits, cls_targets):
        ...
        return self.w_seg * seg + self.w_cls * cls, {"seg_loss": seg.item(), "cls_loss": cls.item()}
